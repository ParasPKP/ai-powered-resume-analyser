...
import { Target, Loader, FileText, Briefcase, CheckCircle } from "lucide-react";
    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#1E1E1E]">
      ...
      <main className="pt-16">
        <div className="max-w-6xl mx-auto px-4 sm:px-8 py-12">
            ...
            <div className="space-y-4">
              ...
              {resumeFile && (
                <div className="bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 rounded-lg p-3">
                  <p className="text-green-700 dark:text-green-300 text-sm font-jetbrains-mono flex items-center">
            ...
            <div className="space-y-4">
              ...
              <div className="bg-white dark:bg-[#262626] rounded-xl p-6">
                <textarea
                  ...
                  placeholder="Paste the job description here...&#10;&#10;Example:&#10;We are looking for a Full Stack Developer with 2+ years experience in React, Node.js, and MongoDB..."
                ...
                <div className="flex justify-between items-center mt-4">
                  <span className="text-xs text-gray-500 dark:text-gray-400 font-jetbrains-mono">
                    {jobDescription.length} characters {!resumeFile && '• Upload resume first'}
                  </span>
                  <button
                    onClick={analyzeMatch}
                    disabled={loading || !resumeFile || !jobDescription.trim()}
                    className="px-6 py-2 bg-blue-600 text-white rounded-lg font-medium hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed transition-colors font-jetbrains-mono text-sm"
                  >
          ...
          {/* Analyze Button - Mobile/Alternate */}
          {resumeFile && jobDescription.trim() && !loading && !matchResults && (
            <div className="mb-8 flex justify-center">
              <button
                onClick={analyzeMatch}
                className="w-full sm:w-auto px-8 py-3 bg-blue-600 text-white rounded-lg font-semibold hover:bg-blue-700 transition-colors font-jetbrains-mono shadow-lg"
              >
                🎯 Analyze Job Match
              </button>
            </div>
